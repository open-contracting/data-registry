...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name="country_en",
            field=models.TextField(
                blank=True, help_text="The official name of the country from which the data originates.", null=True
            ),
        ),
        migrations.AlterField(
            model_name="collection",
        ...
        migrations.AlterField(
            ...
            name="language",
            field=models.TextField(
                blank=True, help_text='The languages used within data fields: for example, "Spanish".'
            ),
        ),
        migrations.AlterField(
            model_name="collection",
            name="language_en",
            field=models.TextField(
                blank=True, help_text='The languages used within data fields: for example, "Spanish".', null=True
            ),
        ),
        migrations.AlterField(
            model_name="collection",
        ...
        migrations.AlterField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="By default, temporary data created by job tasks is deleted after the job is completed. Only the data registry's models' data and JSON exports are retained. To preserve temporary data for debugging, check this box. Then, when ready, uncheck this box and run the \"manageprocess\" management command.",
